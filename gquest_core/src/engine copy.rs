...
pub struct ConditionEngine<'a> {
    ...
    /// The relation graph used for all the functions and their dependencies.
    /// Is an [`Option`] because we sometimes need to take its ownership before putting it back.
